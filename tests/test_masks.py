...
def test_legality_mask_includes_all_legal_moves():
    ...
    mask = legality_mask_batch(xb, boundary_mask, states_meta=None)  # [1,1,V_moves]
...
def test_mask_with_illegal_move_tokens():
    ...
    mask = legality_mask_batch(xb, boundary_mask, states_meta=None)
...
def test_mask_handles_unknown_uci():
    ...
    b = chess.Board("8/7P/8/8/8/8/8/8 w - - 0 1")  # Position where h7h8k would be legal
